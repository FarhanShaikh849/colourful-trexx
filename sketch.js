...
function setup() {
  ...
  gameOver = createSprite(width/2.65,height/2-60);
  gameOver.addImage(gameOverImg);
  gameOver.scale = 0.2;
  gameOver.visible = false;
  
  gameOver2 = createSprite(width/1.65,height/2-60);
...
function draw() {
  ...
  textSize(20);
  fill("black");
  text("Score: "+ score, width/1.5,height/12);
  
  if (gameState===PLAY){
    score = score + Math.round(getFrameRate()/60);
    textSize(20);
    text("HighScore: "+ localStorage["HighestScore"],width/1.5,height/7);
